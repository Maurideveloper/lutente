const imgs0 = document.querySelector('img#img1');
const imgs1 = document.querySelector('img#img2');
const imgs2 = document.querySelector('img#img3');
const imgs3 = document.querySelector('img#img4');
const imgs4 = document.querySelector('img#img5');
//const prev = document.querySelector('.prev');
//const next = document.querySelector('.next');



const imgs = [imgs0, imgs1, imgs2, imgs3, imgs4]
let index = 0;
